        ...
        <div class="row">
            ...
            <table class="table table-responsive table-bordered ">
                ...
                <tr>
                    ...
                    <td><a href="?mod=quanlydanhmucsanpham&xoa=<?php echo $row_danhmuc['dm_id'] ?>">Xóa</a> | <a href="?mod=quanlydanhmucsanpham&quanly=capnhat&id=<?php echo $row_danhmuc['dm_id'] ?>">Sửa</a></td>
                </tr>
                <?php
                }
                ?>
