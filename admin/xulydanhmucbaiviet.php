        ...
        <div class="row">
            ...
            <table class="table table-responsive table-bordered ">
                ...
                <tr>
                    ...
                    <td><a href="?mod=quanlytintuc&xoa=<?php echo $row_danhmuc['danhmuctin_id'] ?>">Xóa</a> | <a href="?mod=quanlytintuc&quanly=capnhat&id=<?php echo $row_danhmuc['danhmuctin_id'] ?>">Sửa</a></td>
                </tr>
                <?php
                }
                ?>
