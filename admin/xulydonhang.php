        ...
        <div class="row">
            ...
            <table class="table table-responsive table-bordered ">
                ...
                <tr>
                    ...
                    }elseif($row_donhang['huydon']==1){ echo '<a href="?mod=quanlydonhang&quanly=xemdonhang&mahang='.$row_donhang["mahang"].'&xacnhanhuy=2">Xác nhận hủy đơn</a>';
                    }else{
                        echo 'Đã hủy';
                    }
                     ?></td>
                    <td><a href="?mod=quanlydonhang&xoadonhang=<?php echo $row_donhang['mahang'] ?>">Xóa</a> | <a href="?mod=quanlydonhang&quanly=xemdonhang&mahang=<?php echo $row_donhang['mahang'] ?>">Xem đơn hàng</a></td>
                </tr>
                <?php
                }
                ?>
