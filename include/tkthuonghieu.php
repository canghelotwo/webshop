...
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Điện Thoại <?php echo $th; ?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								<?php
								$sql_product = mysqli_query($mysqli,"select * from sanpham where sp_name like '%$th%' and dm_id =1 order by sp_id desc");
					...
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2"> 
							...
							<ul>
									...
									<a href="?quanly=tkthuonghieu&th=Nokia">Nokia</a></br>
